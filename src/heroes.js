var Heroes = (function () {
  const list = [
    ...
    },
    {
      ...
      era: "Biblical",
      hp: 110,
      bio: "Last and strongest of the biblical Judges; pulled down a temple to defeat his enemies.",
      stageId: "philistine-temple",
      moves: {
        attack:  { name: "Mighty Strike",       damage: 13, description: "A bone-crushing blow — the highest base attack in the roster." },
        defend:  { name: "Lion Hide",            description: "Halves the next incoming attack." },
        special: { name: "Collapse the Pillars", damage: 30, description: "Deals 30 damage to opponent and 12 damage to self. Samson could KO himself." }
      },
      trivia: [
        {
          question: "What was the source of Samson's strength?",
          options: ["His hair (uncut by Nazirite vow)", "His muscles", "His armor", "His staff"],
          correctIndex: 0,
          explanation: "Samson's strength came from his uncut hair as part of his Nazirite vow. Cutting it severed his connection to God and his power."
        },
        {
          question: "Who betrayed Samson by revealing the secret of his strength?",
          options: ["Delilah", "Esther", "Ruth", "Bathsheba"],
          correctIndex: 0,
          explanation: "Delilah, paid by the Philistine lords, repeatedly asked Samson the secret of his strength until he revealed it. She had his hair cut while he slept."
        },
        {
          question: "What did Samson kill with his bare hands?",
          options: ["A lion", "A bear", "A wolf", "A serpent"],
          correctIndex: 0,
          explanation: "On his way to Timnah, a young lion attacked Samson and he tore it apart with his bare hands as easily as one would tear a young goat."
        },
        {
          question: "What did Samson later find inside the carcass of the lion he killed?",
          options: ["A swarm of bees and honey", "Gold coins", "A scroll", "A serpent"],
          correctIndex: 0,
          explanation: "Bees had built a hive in the lion's carcass. Samson ate the honey, which inspired his famous riddle: 'Out of the eater came something to eat, out of the strong came something sweet.'"
        },
        {
          question: "What weapon did Samson use to defeat a thousand Philistines?",
          options: ["A sword", "The jawbone of a donkey", "A sling", "A spear"],
          correctIndex: 1,
          explanation: "Samson grabbed the fresh jawbone of a donkey and struck down a thousand Philistine warriors at a place that came to be called Ramath-lehi — 'the hill of the jawbone.'"
        },
        {
          question: "Samson is the last of the biblical:",
          options: ["Prophets", "Kings", "Judges", "Patriarchs"],
          correctIndex: 2,
          explanation: "Samson was the twelfth and final Judge of Israel, before the era of kings began. The Book of Judges concludes with his story."
        },
        {
          question: "Samson was bound by which sacred vow from birth?",
          options: ["The Nazirite vow", "The Levirate marriage", "The Sabbath covenant", "The Tithe of Ten"],
          correctIndex: 0,
          explanation: "An angel told Samson's mother that her son would be a Nazirite — set apart for God, never cutting his hair, drinking wine, or touching corpses."
        },
        {
          question: "What was Samson's final act?",
          options: ["Pulled down a temple's pillars", "Defeated King Saul", "Wrestled an angel", "Climbed Mount Sinai"],
          correctIndex: 0,
          explanation: "Blinded and chained, Samson prayed for strength one last time, then pushed apart the two central pillars of a Philistine temple, killing himself and thousands of his enemies."
        },
        {
          question: "The Philistines were Samson's:",
          options: ["Friends", "Enemies", "Cousins", "Followers"],
          correctIndex: 1,
          explanation: "The Philistines ruled over the Israelites during Samson's time. He was raised up by God specifically to begin Israel's deliverance from them."
        },
        {
          question: "What did the Philistines do to Samson after they captured him?",
          options: ["Crowned him king", "Blinded him", "Made him a scribe", "Forced him to marry"],
          correctIndex: 1,
          explanation: "The Philistines gouged out Samson's eyes, bound him in bronze chains, and put him to grinding grain in prison — his final humiliation."
        },
        {
          question: "Samson regained his strength when his:",
          options: ["Hair grew back", "Prayers were answered", "Anger returned", "Hunger was fed"],
          correctIndex: 0,
          explanation: "While imprisoned, Samson's hair began to grow again. With it, his strength gradually returned — enough for one final, devastating act."
        },
        {
          question: "In which book of the Hebrew Bible does Samson appear?",
          options: ["Genesis", "Exodus", "Judges", "Kings"],
          correctIndex: 2,
          explanation: "Samson's full story is told in Judges chapters 13-16, near the end of the Book of Judges."
        },
        {
          question: "Samson was from which tribe of Israel?",
          options: ["Levi", "Judah", "Dan", "Benjamin"],
          correctIndex: 2,
          explanation: "Samson was born to Manoah of the tribe of Dan, which lived in the lowlands near Philistine territory — a frontier of constant conflict."
        },
        {
          question: "What was the subject of Samson's famous riddle?",
          options: ["Lions and honey", "Sheep and gold", "Olives and oil", "Fish and water"],
          correctIndex: 0,
          explanation: "After eating honey from a dead lion's carcass, Samson posed: 'Out of the eater, something to eat; out of the strong, something sweet.' His Philistine bride pried the answer from him."
        },
        {
          question: "The Hebrew word 'Nazir' (Nazirite) means:",
          options: ["Dedicated / set apart", "Strong as a lion", "Wise of heart", "Brave warrior"],
          correctIndex: 0,
          explanation: "A Nazirite was 'set apart' for God — abstaining from wine, avoiding corpses, and never cutting their hair. Samson, Samuel, and (some say) John the Baptist were all Nazirites."
        },
        {
          question: "How was Samson conceived?",
          options: ["His parents had been childless for many years", "He was born of royal lineage", "His parents were Philistine", "He was a foundling"],
          correctIndex: 0,
          explanation: "An angel of the Lord appeared to Samson's mother, who had been barren, and announced she would bear a son who would deliver Israel from the Philistines."
        },
        {
          question: "Samson's first wife was:",
          options: ["Hebrew (Israelite)", "Philistine", "Egyptian", "Moabite"],
          correctIndex: 1,
          explanation: "Samson chose a Philistine woman of Timnah as his first wife, against his parents' wishes. Their wedding ended in tragedy after his riddle was betrayed."
        },
        {
          question: "Before each great feat of strength, Samson was filled with:",
          options: ["Holy water", "The Spirit of the Lord", "Wine", "A magical potion"],
          correctIndex: 1,
          explanation: "The Book of Judges repeatedly says 'the Spirit of the Lord came upon him mightily' before each of Samson's superhuman acts."
        },
        {
          question: "How many years did Samson serve as judge of Israel?",
          options: ["7", "20", "40", "70"],
          correctIndex: 1,
          explanation: "Samson judged Israel for 20 years during the period of Philistine domination. His personal exploits, more than his governance, define his legacy."
        },
        {
          question: "The name 'Samson' likely means:",
          options: ["Sunlike", "Man of God", "Strong arm", "Lion-hearted"],
          correctIndex: 0,
          explanation: "Samson (Hebrew: Shimshon) likely derives from 'shemesh' meaning 'sun' — fitting for a hero of brilliant, blazing power."
        }
      ]
    },
    {
